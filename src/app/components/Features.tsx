...
const FeatureCard = ({ feature }: { feature: Feature }) => {
    return (
        <div className="group relative p-8 rounded-3xl border border-white/5 bg-white/2 backdrop-blur-sm hover:bg-white/5 transition-all duration-500 hover:-translate-y-2">
            <div className={`absolute -inset-px bg-linear-to-r ${feature.color} opacity-0 group-hover:opacity-10 rounded-3xl transition-opacity duration-500`}></div>
            <div className="relative z-10 space-y-4">
                <div className={`w-12 h-12 rounded-2xl bg-linear-to-r ${feature.color} flex items-center justify-center text-white shadow-lg shadow-black/20`}>
                    {feature.icon}
                </div>
        ...
        <section id="features" className="relative py-24 bg-[#05070a] overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <div className="max-w-2xl mb-20 space-y-4">
                    <h2 className="text-blue-500 font-semibold tracking-wider text-sm uppercase px-1">Features</h2>
                    <h3 className="text-4xl md:text-5xl font-bold text-white leading-tight">
                        Engineered for the <br />
                        <span className="text-gray-500">Modern Web</span>
                    </h3>
                    <p className="text-lg text-gray-400">
                        NovaUI isn&apos;t just another component library. It&apos;s a technical foundation for building high-scale, type-safe web applications.
                    </p>
                </div>
