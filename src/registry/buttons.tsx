...
import {
  Sparkles, Loader2, Plus, Trash2, CheckCircle2, Search, ArrowRight, ExternalLink,
  Zap, MousePointer2, Layers, Cpu, Shield, Send, Bell, Star
} from "lucide-react";
...
export default function FAB() {
  ...
  },
  {
    id: "shimmer",
    name: "Shimmer Button",
    description: "Premium button with a continuous light streak effect, perfect for primary AI or Pro features.",
    preview: (
...
export default function ShimmerButton() {
  return (
    ...
    `,
    usage: "High-end CTA. Ensure you have the 'shimmer' keyframe defined in your tailwind config or global CSS."
  },
  {
    id: "magnetic",
    name: "Magnetic Button",
    description: "Ultra-interactive button that tracks the cursor, creating a 'magnetic' pull effect.",
    preview: (
      <motion.button
...
export default function MagneticButton() {
  ...
  return (
    ...
    `,
    usage: "Use for high-conversion CTAs. The magnetic effect works best on larger screen sizes."
  },
  {
    id: "three-d-press",
    name: "3D Press Button",
    description: "Tactile, physical-feeling button that depresses in 3D space when clicked.",
    preview: (
...
export default function ThreeDPressButton() {
  return (
    ...
    `,
    usage: "Great for gamified UIs or 'Big Red' action buttons. Uses CSS shadows for the 3D depth."
  },
  {
    id: "shiny-gradient",
    name: "Shiny Gradient Button",
    description: "Dynamic button with a rotating or shifting gradient background for a high-tech vibe.",
    preview: (
...
export default function ShinyGradientButton() {
  return (
    ...
    `,
    usage: "Best for AI features or premium SaaS tiers. The `bg-[length:200%_auto]` allows for smooth gradient shifts."
  },
  {
    id: "animated-border",
    name: "Animated Border Button",
    description: "Button with a light orbiting around its border, creating a high-energy focus point.",
    preview: (
      <div className="relative p-[1px] rounded-xl bg-slate-800 overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-indigo-500 via-transparent to-pink-500 animate-spin-slow opacity-50" />
...
export default function AnimatedBorderButton() {
  return (
    <div className="relative p-[2px] rounded-xl bg-slate-800 overflow-hidden group">
    ...
    `,
    usage: "Use for primary actions that need to stand out from a dark background. Ensure `spin` animation is available."
  },
  {
    id: "glass",
    name: "Premium Glass Button",
    description: "Exquisite frosted glass effect with high-fidelity blurs and vibrant stroke highlights.",
    preview: (
...
export default function GlassButton() {
  return (
    ...
    `,
    usage: "Perfect for secondary actions on vibrant or complex backgrounds. Uses `backdrop-blur-2xl` for peak clarity."
  },
  {
    id: "icon-reveal",
    name: "Icon Reveal Button",
    description: "Clean text button that elegantly slides an icon into view upon interaction.",
    preview: (
      <button className="group flex items-center gap-0 px-8 py-3 bg-[#6366F1] text-white font-black rounded-xl overflow-hidden transition-all hover:gap-3">
        ...
        <ArrowRight size={20} className="-translate-x-full opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300" />
      </button>
    ),
    code: `
...
export default function IconRevealButton() {
  return (
    ...
    `,
    usage: "Use to reduce visual clutter for navigation or form submission triggers."
  },
  {
    id: "glow-pulse",
    name: "Glow Pulse Button",
    description: "Button that features a breathing neon glow, ideal for live status or urgent alerts.",
    preview: (
...
export default function GlowPulseButton() {
  return (
    ...
    `,
    usage: "Ideal for dashboard notifications or urgent CTA actions. The pulse animation provides high visual priority."
  }
];
