...
export default function AnimatedBorderButton({
  ...
  return (
    <div className="w-40 relative p-[2px] rounded-xl bg-slate-800 overflow-hidden group w-fit">
      ...
      <button
        className={cn(
          "w-40 relative px-8 py-3 bg-[#111827] text-white font-bold rounded-[10px] z-10 w-full active:scale-95 transition-transform hover:bg-[#1f2937] disabled:opacity-50 disabled:cursor-not-allowed",
