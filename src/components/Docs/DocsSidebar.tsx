...
const sidebarSections: SidebarSection[] = [
    {
        ...
        items: [
            ...
            { name: "Getting Started", href: "/docs/getting-started", icon: <Layers size={18} /> },
            { name: "Validation", href: "/docs/validation", icon: <ShieldCheck size={18} /> },
        ],
    },
    {
        title: "Components",
            ...
            <div className="space-y-10">
                {sidebarSections.map((section) => (
                    <div key={section.title} className="space-y-4">
                        <p className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] px-2">{section.title}</p>
